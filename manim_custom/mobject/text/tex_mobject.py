...
from manim_custom.utils.tex_file_writing import tex_to_svg_file


class SingleStringMathTexCustom(SingleStringMathTex):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(SingleStringMathTex, self).__init__(
            file_name=file_name,
        ...
        if self.organize_left_to_right:
            self._organize_submobjects_left_to_riht()
            
            
class MathTexPdf2Svg(SingleStringMathTexCustom):
    ...
    def _break_up_by_substrings(self):
        ...
        for tex_string in self.tex_strings:
            sub_tex_mob = SingleStringMathTexCustom(
                tex_string,
                tex_environment=self.tex_environment,
                tex_template=self.tex_template,
            )
